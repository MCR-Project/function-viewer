...
/** Reads every selected supported-language file's text, keyed by its path relative to the picked root. */
export async function collectSourceFiles(fileList: FileList): Promise<{ root: string; files: FileUpload[] }> {
